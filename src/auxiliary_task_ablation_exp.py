...
def get_loaders(args, train_path, valid_path, aux_task="SPEAKER"):
...
if __name__ == "__main__":
    ...
    train_loader, eval_loader, class_weight = get_loaders(args, train_src_path, valid_src_path, aux_task=args.aux_task)  
