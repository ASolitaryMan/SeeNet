...
def get_loaders(args, train_path, valid_path, is_aug=False, aug_mtd="EMP"):
...
if __name__ == "__main__":
    ...
    train_loader, eval_loader, class_weight = get_loaders(args, train_src_path, valid_src_path, is_aug=args.is_augment, aug_mtd=args.method_augment)  
